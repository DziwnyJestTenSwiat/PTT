...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'broadway.saga.state.in_memory_repository' => 'getBroadway_Saga_State_InMemoryRepositoryService',
            'broadway.saga.state.state_manager' => 'getBroadway_Saga_State_StateManagerService',
            'broadway.simple_interface_serializer' => 'getBroadway_SimpleInterfaceSerializerService',
            'broadway.uuid.converter' => 'getBroadway_Uuid_ConverterService',
        ...
        $this->aliases = array(
            ...
            'broadway.saga.state.repository' => 'broadway.saga.state.in_memory_repository',
            'broadway.serializer.metadata' => 'broadway.simple_interface_serializer',
            'broadway.serializer.payload' => 'broadway.simple_interface_serializer',
            'broadway.serializer.readmodel' => 'broadway.simple_interface_serializer',
    ...
    {
        return $this->services['broadway.elasticsearch.client'] = (new \Broadway\ReadModel\ElasticSearch\ElasticSearchClientFactory())->create(array('hosts' => array(0 => 'localhost:9200')));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\EventDispatcher\CallableEventDispatcher A Broadway\EventDispatcher\CallableEventDispatcher instance
     */
    protected function getBroadway_EventDispatcherService()
    {
        $this->services['broadway.event_dispatcher'] = $instance = new \Broadway\EventDispatcher\CallableEventDispatcher();
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\EventStore\Dbal\DBALEventStore A Broadway\EventStore\Dbal\DBALEventStore instance
     */
    protected function getBroadway_EventStore_DbalService()
    {
        $a = $this->get('broadway.simple_interface_serializer');

        return $this->services['broadway.event_store.dbal'] = new \Broadway\EventStore\Dbal\DBALEventStore($this->get('doctrine.dbal.default_connection'), $a, $a, 'events', true, $this->get('broadway.uuid.converter'));
    }
    ...
    {
        return $this->services['broadway.read_model.elasticsearch.repository_factory'] = new \Broadway\ReadModel\ElasticSearch\ElasticSearchRepositoryFactory($this->get('broadway.elasticsearch.client'), $this->get('broadway.simple_interface_serializer'));
    }
    ...
    {
        return $this->services['broadway.saga.multiple_saga_manager'] = new \Broadway\Saga\MultipleSagaManager($this->get('broadway.saga.state.in_memory_repository'), array(), $this->get('broadway.saga.state.state_manager'), $this->get('broadway.saga.metadata.factory'), $this->get('broadway.event_dispatcher'));
    }

    /**
     * Gets the 'broadway.saga.state.in_memory_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\Saga\State\InMemoryRepository A Broadway\Saga\State\InMemoryRepository instance
     */
    protected function getBroadway_Saga_State_InMemoryRepositoryService()
    {
        return $this->services['broadway.saga.state.in_memory_repository'] = new \Broadway\Saga\State\InMemoryRepository();
    }
    ...
    {
        return $this->services['broadway.saga.state.state_manager'] = new \Broadway\Saga\State\StateManager($this->get('broadway.saga.state.in_memory_repository'), $this->get('broadway.uuid.generator'));
    }

    /**
     * Gets the 'broadway.simple_interface_serializer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\Serializer\SimpleInterfaceSerializer A Broadway\Serializer\SimpleInterfaceSerializer instance
     */
    protected function getBroadway_SimpleInterfaceSerializerService()
    {
        return $this->services['broadway.simple_interface_serializer'] = new \Broadway\Serializer\SimpleInterfaceSerializer();
    }

    /**
     * Gets the 'broadway.uuid.converter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\UuidGenerator\Converter\BinaryUuidConverter A Broadway\UuidGenerator\Converter\BinaryUuidConverter instance
     */
    protected function getBroadway_Uuid_ConverterService()
    {
        return $this->services['broadway.uuid.converter'] = new \Broadway\UuidGenerator\Converter\BinaryUuidConverter();
    }
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KLxwMqeSv0', 0, 'r2yI79+qIrinoZhVj9O8Sa', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'ptt', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fE1qHIkIjW', 0, 'r2yI79+qIrinoZhVj9O8Sa', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58df66810e2b01.71148136')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles_metadata' => array(
                ...
                'BroadwayBundle' => array(
                    'parent' => NULL,
                    'path' => '/app/vendor/broadway/broadway-bundle/src',
            ...
            'broadway.event_store.dbal.use_binary' => true,
